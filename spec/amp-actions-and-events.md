...
<table>
  ...
  <tr>
    ...
    <td>When navigate is false or unspecified, goBack will attempt to go back in history while remaining in the current document. When navigate is true, the action will allow for cross-document navigation, similarly to [history.back](https://developer.mozilla.org/en-US/docs/Web/API/History/back).</td>
  </tr>
  <tr>
